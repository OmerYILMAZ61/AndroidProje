...
public class PersonRest {
	...
	@POST
	@Path("/post")
	public String kullaniciEkle(@FormParam("id") int id,@FormParam("name") String name){
	...
	public Response kullaniciEklePut(String json){
	...
	public Response kullaniciGuncelle(@PathParam("param1") int id, @FormParam("name") String name){
		Person person = PersonServis.getInstance().personList.get(id);
		person.setName(name);
